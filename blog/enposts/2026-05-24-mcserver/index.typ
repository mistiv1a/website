...
目前最流行的启动器是#link("https://prismlauncher.org/", "Prism Launcher")。但是这个启动器只支持正版，如果需要也带上一些没有购买正版游戏的朋友，则需要换个启动器，例如#link("https://polymc.org/", "PolyMC")。此两者系出同源，皆fork自#link("https://multimc.org/", "MultiMC")，然而整合包却不兼容，需要分别制作。
