...
针对以上问题，我最近开发了一个新的个人直播工具，名叫EZLive。托管在了GitHub上： [mistivia/ezlive](https://github.com/mistivia/ezlive)。
...
然后，需要设置跨域访问（CORS）。EZLive项目自带了一个HLS播放器，托管在了Github Page上： [mistivia/ezlive/tree/gh-pages](https://github.com/mistivia/ezlive/tree/gh-pages)

访问地址是：[https://mistivia.github.io/ezlive](https://mistivia.github.io/ezlive)
...
首先需要去发布页面下载EZLive：[https://github.com/mistivia/ezlive/releases/](https://github.com/mistivia/ezlive/releases/)
