...
公历，也就是现行的格里高利历，大多数人在小学的时候就学过，其规则也很简单。但是农历则不然，每一年春节似乎都在变动，和立春的日子根本不一样，却又总在它附近。而闰月更是让人摸不着头脑，每一个月都有可能称为闰月。
...
越南也遵循传统使用农历，并且和中国基本相同。所以，农历新年被称为“Chinese New
Year”的时候，越南互联网上还有一些反对的声音，很多英文媒体也因此把农历新年改作“Lunar New Year”。
...
闰月是农历中最复杂的部分。一个回归年大致是365.2422天，而一个朔望月是29.5天。如果一年记12个月，那么就只有29.5 × 12 = 354天。差不多每隔两三年就会和回归年偏差一个月。因此，当偏差发生时，就要增加额外一个月来补偿。这就是闰月。
...
第三个阶段，在明末的《崇祯历书》中，农历进行了一次更大的升级，变成了今天的样子。

= 现代的农历

去读《崇祯历书》有点麻烦。所幸紫金山天文台在2017年参与制定了一部农历的国家标准《#link("https://openstd.samr.gov.cn/bzgk/gb/newGbInfo?hcno=E107EA4DE9725EDF819F33C60A44B296", [农历的编算和颁行（GB/T 33661-2017）])》，对于农历如何置闰做了精确的描述。
...
虽然《崇祯历书》已经实行了三百年，但是民间往往还因循守旧，使用古老的“无中气置闰法”。在大多数年份，这两者其实一样，但是因为种种细微的偏差，在 2033年，“无中气置闰法”和现代的农历置闰法会发生冲突。2033年比较特殊，这个农历年会有两个无中气的月份，分别是（原本的）八月和（原本的）十二月。如果按照“无中气置闰法”，那么（原本的）八月就会变成七月的闰月，也就是闰七月，但是因为从2032年农历十一月开始到2033
年农历十一月之间只有12个农历月，而2033年的农历十一月到2034年的农历十一月之间才会有13个农历月，所以闰月应该放在这一年的第二个无中气的月份：十二月，让十二月成为闰十一月。而一些不采用现代置闰法的民间的“万年历”在这里就可能会有错误，这会导致中秋节偏差了一个月。
