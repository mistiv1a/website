...
[lmp](./pages/lmp.html): 一个整活项目。用C++模板元编程实现了类似Lisp的功能（cons, car, cdr, reverse, 等等）。曾[一度登上Hacker News首页](https://news.ycombinator.com/item?id=47292029)。

[mvvmm](./pages/mvvmm.html): 我的得意作品，用1000多行C代码实现了完整的基于KVM的虚拟机管理器，实现了块设备和网络设备的VirtIO模拟，可以运行主流Linux发行版，并且性能不低。
